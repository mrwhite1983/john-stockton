...
<br>
 ...
 <center><h1> BTG Front End Inventory - Add Inventory  </h1></center>
...
Enter a quantity then scan barcode. Or you could simply scan each item and we'll count for you.
<br>
...
<form action="floor_count.php" method='post' name="post">
